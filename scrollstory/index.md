...
{% include scrollybox/bg-multi-long.html
  bg-id="bg1"
  image-path="scrollstory/images/holderlin-statue-neckar-river.jpg"
  above-box-space="0"
  font-size = "150%"
  line-height = "100%"
%}
...
A statue of Frieddrich Hölderlin overlooking the Neckar river.


### IMAGE SWITCH HERE 

{% include scrollybox/bg-switch.html
  image-path="scrollstory/images/forest.png"
  switch-id="switch1"
  bg-id="bg1"
%}
